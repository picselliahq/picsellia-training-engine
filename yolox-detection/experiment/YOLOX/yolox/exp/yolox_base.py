...
class Exp(BaseExp):
    def __init__(self, args):
        ...
        self.input_size = args.image_size  # (height, width)
        ...
        self.train_ann = args.train_ann
        # name of annotation file for evaluation
        self.val_ann = args.val_ann
        # name of annotation file for testing
        self.test_ann = args.test_ann
        ...
        self.basic_lr_per_img = args.learning_rate
        # name of LRScheduler
    ...
    def get_dataset(self, cache: bool = False, cache_type: str = "ram"):
        ...
        """
        from YOLOX.yolox.data import COCODataset, TrainTransform
    ...
    def get_evaluator(self, batch_size, is_distributed, testdev=False, legacy=False):
        from YOLOX.yolox.evaluators import COCOEvaluator
