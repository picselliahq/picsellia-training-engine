...
#docker build . -f yolov8-detection-refactored/Dockerfile -t picsellia/training-yolov8-detection:test
#docker push picsellia/training-yolov8-detection:test
#
#docker build . -f yolov8-segmentation-refactored/Dockerfile -t picsellia/training-yolov8-segmentation:test
